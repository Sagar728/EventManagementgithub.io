    ...
    <ul class="navbar-nav navbar-nav-left">
        ...
        {  
         ...
         <li class="nav-item dropdown">
          ...
          <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://api.whatsapp.com/send?phone=917755954728&text=Hi%20Sagar,%20I%20saw%20your%20Project%20named%20as%20Royal%20Event%20Software.%20I%20need%20your%20help%20for%20the%20same.
          ">
               
                <span class="menu-title" title = "Contact Admin">Contact Admin</span>
            </a>
                  </li> 

                  <li class="nav-item dropdown">
            <a class="nav-link" href="fetch_data.php">Operation</a>
          </li>
