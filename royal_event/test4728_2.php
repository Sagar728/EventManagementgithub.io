...
if(isset($_POST['update_product'])){
   ...
   $VenueAddress = filter_var($VenueAddress, FILTER_SANITIZE_STRING);
   $MobileNumber = $_POST['MobileNumber'];
   $MobileNumber = filter_var($MobileNumber, FILTER_SANITIZE_STRING);

   
   $apidata=array("Name"=>$Name,"ID"=>$ID,"category"=>$Email,"details"=>Email,"VenueAddress"=>$VenueAddress,"MobileNumber"=>$MobileNumber);
   $encoded_data=json_encode($apidata);
   //Calling the update.php REST api to update details through HTTP PUT method....Since PHP ha only GET and POST as built in HTTP methods we modify the POST method such that it behaves like a PUT method
$url="http://localhost/Royal%20Event/Royal%20Event/royal_event/update.php/";
$curl=curl_init();
...
<section class="update-product">
   ...
   <?php
      ...
      $select_products = $conn->prepare("SELECT * FROM `tblbooking` WHERE id = ?");
